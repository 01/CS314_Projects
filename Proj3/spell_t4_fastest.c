/**************************************************************************\
  ...
  *	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  *	********************************************************************* *
  *	*   This is a rough guideline regarding the expected performance of * *
  *	*   your differenT code versions. These are the best times			* *
  *	*   that our sample solutions were able to achieve:					* *
  *	*																	* *
  *	*	 spell_t4_fastest  cs314isgreat   0.032 secs					* *
  *	*	 singleton.cs.rutgers.edu when it was lightly loaded. 			* *
  *	*																	* *
  * ********************************************************************* *
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
\***************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	#pragma omp parallel for private(i,j)		// Segfault on bv[hash]
	for (i = 0; i < wl_size; i++) {
		for (j = 0; j < num_hf; j++) {
